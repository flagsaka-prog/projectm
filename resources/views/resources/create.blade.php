...
@section('page-title', 'Tambah Resource')
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="type" required
                            ...
                            <option value="human" {{ old('type') === 'human' ? 'selected' : '' }}>Human</option>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="max_units" value="{{ old('max_units') }}" step="0.01"
                                min="0"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Std Rate (per jam)</label>
                            <input type="number" name="std_rate" value="{{ old('std_rate') }}" step="0.01"
                                min="0"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="number" name="ovt_rate" value="{{ old('ovt_rate') }}" step="0.01"
                                min="0"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Cost Per Use</label>
                            <input type="number" name="cost_per_use" value="{{ old('cost_per_use') }}" step="0.01"
                                min="0"
                                class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="accrue_at"
                            class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            <option value="">-- Pilih --</option>
                            <option value="start" {{ old('accrue_at') === 'start' ? 'selected' : '' }}>Start</option>
                            <option value="end" {{ old('accrue_at') === 'end' ? 'selected' : '' }}>End</option>
                            <option value="prorated" {{ old('accrue_at') === 'prorated' ? 'selected' : '' }}>Prorated
                            </option>
                        </select>
                    </div>
                </div>
